...
{
    TCHAR FirstChar[] = TEXT("김이박최신");
    TCHAR MiddleChar[] = TEXT("상혜지성현하");
    TCHAR LastChar[] = TEXT("수은원연승연");

    TArray<TCHAR> RandArray;
    RandArray.SetNum(3);
    RandArray[0] = FirstChar[FMath::RandRange(0, 4)];
    RandArray[1] = MiddleChar[FMath::RandRange(0, 5)];
    RandArray[2] = LastChar[FMath::RandRange(0, 5)];
...
void UMyGameInstance::Init()
{
    ...
    const FString TargetName(TEXT("신현승"));
